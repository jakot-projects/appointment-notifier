...
val SEARCH_DATA_DEFAULT = FirstAvailableSearchData(
    visitMotive = "2126313",
    practice = "133110",
    doctor = "638502",
    dateThreshold = LocalDate.now()
)
...
fun buildAvailableTimesQuery(firstAvailableSearchData: FirstAvailableSearchData): String {
    return buildAvailableTimesQuery(
        firstAvailableSearchData.visitMotive,
        firstAvailableSearchData.doctor,
        firstAvailableSearchData.practice,
